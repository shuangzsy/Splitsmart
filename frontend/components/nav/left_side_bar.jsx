    ...
    return (
      <div>
        <ul className="left_side_bar_list">
          ...
          <li className="activity"><Link to="/activity">Recent activity</Link></li>
          <li className="filter"><input type="text" placeholder="filter by name"/></li>
          <li className="all"><Link to="/all">All Expenses</Link></li>
